...
from .abstract_classes_adjectives_main import AdjectivesContainer, Comment, Comments
...
#
# c1 = CommentImplemented("дуже ахуєнний.", 10)
# c2 = CommentImplemented("дуже хуйовий.", 2)
